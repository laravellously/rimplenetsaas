                ...
                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5">
                                ...
                                @foreach ($wallets as $w)
                                    <tr wire:key="item-{{ $w->wallet_name }}">
                                        ...
                                        <td
                                            ...
                                            <button wire:click="deleteWallet('{{ $w->wallet_id }}')"
                                                class="text-cyan-700 hover:text-cyan-900">Delete<span class="sr-only">
                                                    {{ $w->wallet_name }}</span></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    @else
                        <div class="py-16 text-center">
                            ...
                            <div class="mt-6">
                                <button type="button" wire:click="createTestWallet" wire:loading.attr="disabled"
...
@section('javascript')
    ...
    <script>
        Livewire.on('walletDeleted', () => {
            setTimeout(function() {
                popToast("success", "Completed");
            }, 10);
        })

        Livewire.on('walletNotCreated', () => {
            setTimeout(function() {
                popToast("danger", "Wallet was NOT created!");
            }, 10);
        })
